...
import { Menu, Volume2, UtensilsCrossed, Bus, GraduationCap, ShoppingBag, ChevronRight, Construction, HeartPulse, Landmark, Briefcase, LayoutGrid, Users, ShieldAlert, Home, Zap, Scale, AlertTriangle } from 'lucide-react';
import { Button } from "@/components/ui/button";
import { Card, CardContent, CardFooter, CardHeader, CardTitle } from "@/components/ui/card";

// --- 台灣通 300 句：完整資料倉庫 (無省略版) ---
const taiwan300Data = [
  // 1-30 (略，已包含在下方內容中)
  ...
  { id: 29, category: "銀行", chinese: "我想換錢，哪裡有銀行？", pinyin: "Wǒ xiǎng huànqián, nǎlǐ yǒu yínháng?", vietnamese: "Tôi muốn đổi tiền, ở đâu có ngân hàng?" },
  ...
  { id: 97, category: "醫療", chinese: "醫生，我對這種藥過敏。", pinyin: "Yīshēng, wǒ duì zhèzhǒng yào guòmǐn", vietnamese: "Bác sĩ, tôi bị dị ứng with loại thuốc này." },
  ...
  { id: 109, category: "社交", chinese: "你有 LINE 或臉書嗎？", pinyin: "Nǐ v yǒu LINE huò liǎnshū ma?", vietnamese: "Bạn có LINE hay Facebook không?" },
  ...
  { id: 157, category: "生活", chinese: "你可以幫我拍張照嗎？", pinyin: "Nǐ kěyǐ bāng wǒ pāizhāngzhào ma?", vietnamese: "Bạn có thể chụp giúp tôi một kiểu ảnh không?" },
  { id: 158, category: "生活", chinese: "我們拍張合照吧！", pinyin: "Wǒmen pāizhāng hézhào ba!", vietnamese: "Chúng mình cùng chụp ảnh chung nhé!" },
  ...
  { id: 165, category: "生活", chinese: "我換了住址，要報備嗎？", pinyin: "Wǒ huànle zhùzhǐ", vietnamese: "Tôi thay đổi địa chỉ, có phải khai báo không?" },
  { id: 166, category: "生活", chinese: "請問遺失護照要先去警察局嗎？", pinyin: "Qǐngwèn yíshī hùzhào", vietnamese: "Cho hỏi mất hộ chiếu có phải ra đồn cảnh sát trước không?" },
  ...
  { id: 195, category: "生活", chinese: "辛苦了！謝謝你的幫忙。", pinyin: "Xīnkǔle! Xièxie nǐ de bāngmáng", vietnamese: "Bạn vất vả rồi! Cảm ơn sự giúp đỡ của bạn." },
  { id: 196, category: "生活", chinese: "下次換我請你吃飯。", pinyin: "Xià cì huàn wǒ qǐng nǐ chīfàn", vietnamese: "Lần sau đến lượt tôi mời bạn đi ăn cơm nhé." },
  ...
  { id: 199, category: "飲食", chinese: "這家店的小籠包很有名。", pinyin: "Zhè jiā diàn de xiǎolóngbāo hěn yǒumíng", vietnamese: "Tiểu long bao của quán này very nổi tiếng." },
  ...
  { id: 213, category: "生活", chinese: "祝你一路順風！", pinyin: "Zhù nǐ yīlù shùnfēng!", vietnamese: "Chúc bạn thượng lộ bình an!" },
  ...
  { id: 215, category: "生活", chinese: "我可以幫你拿東西嗎？", pinyin: "Wǒ kěyǐ bāng nǐ ná dōngxi ma?", vietnamese: "Tôi có thể giúp bạn cầm đồ không?" },
  ...
  { id: 223, category: "生活", chinese: "你說得太快了，我聽不懂。", pinyin: "Nǐ shuō de tài kuàile", vietnamese: "Bạn nói nhanh quá, tôi không hiểu." },
  { id: 224, category: "生活", chinese: "可以請你再說一遍嗎？", pinyin: "Qǐng nǐ zài shuō yībiàn ma?", vietnamese: "Có thể phiền bạn nói lại một lần nữa không?" },
  ...
  { id: 244, category: "生活", chinese: "我要補辦全民健保卡。", pinyin: "Wǒ yào bǔbàn quánmín jiànbǎokǎ", vietnamese: "Em muốn làm lại thẻ bảo hiểm y tế toàn dân." },
  { id: 245, category: "生活", chinese: "身分證明文件要帶哪些？", pinyin: "Shēnfèn zhèngmíng wénjiàn", vietnamese: "Cần mang theo những giấy tờ chứng minh nhân thân nào?" },
  { id: 246, category: "生活", chinese: "我想換手機外殼。", pinyin: "Wǒ xiǎng huàn shǒujī wàiké", vietnamese: "Tôi muốn thay ốp điện thoại." },
  { id: 247, category: "生活", chinese: "哪裡有賣運動鞋？", pinyin: "Nǎlǐ yǒu mài yùndòngxié?", vietnamese: "Ở đâu有 bán giày thể thao nhỉ?" },
  ...
  { id: 249, category: "生活", chinese: "不用客氣，大家都是好朋友。", pinyin: "Bùyòng kèqi", vietnamese: "Đừng khách sáo, mọi người đều là bạn tốt mà." },
  { id: 250, category: "生活", chinese: "有空來我宿舍玩！", pinyin: "Yǒukòng lái wǒ sùshè wán!", vietnamese: "Khi nào rảnh qua ký túc xá mình chơi nhé!" },
  ...
  { id: 262, category: "生活", chinese: "這附近有書局嗎？", pinyin: "Zhè fùjìn yǒu shūjú ma?", vietnamese: "Gần đây有 hiệu sách không?" },
  ...
  { id: 274, category: "生活", chinese: "護照過期了，要去領事事務局換發。", pinyin: "Hùzhào guòqīle", vietnamese: "Hộ chiếu hết hạn rồi, phải ra Cục Lãnh sự để đổi mới." },
  ...
  { id: 281, category: "交通", chinese: "這附近哪裡有加油站？", pinyin: "Zhè fùjìn nǎlǐ yǒu jiāyóuzhàn?", vietnamese: "Gần đây有 trạm xăng không?" },
  ...
  { id: 285, category: "生活", chinese: "這附近有全家便利商店嗎？", pinyin: "Zhè fùjìn yǒu Quánjiā biànlì shāngdiàn ma?", vietnamese: "Gần đây有 cửa hàng Family Mart không?" },
  { id: 286, category: "生活", chinese: "這張照片拍得真好看，可以傳給我嗎？", pinyin: "Zhè zhāng zhàopiàn pāi de zhēn hǎokàn", vietnamese: "Bức ảnh này chụp đẹp quá, có thể gửi cho tôi không?" },
  { id: 287, category: "生活", chinese: "你的越南文說得越來越好了！", pinyin: "Nǐ de Yuènánwén shuō de yuèláiyuè hǎole!", vietnamese: "Tiếng Việt của bạn nói ngày càng tốt hơn rồi!" },
  ...
  { id: 292, category: "生活", chinese: "哪裡有大創百貨？", pinyin: "Nǎlǐ yǒu Dàchuàng bǎihuò?", vietnamese: "Ở đâu有 bách hóa Daiso?" },
  { id: 293, category: "生活", chinese: "我要買這個指甲油。", pinyin: "Wǒ yào mǎi zhège zhǐjiǎyóu", vietnamese: "Tôi muốn mua lọ sơn móng tay này." },
  { id: 294, category: "生活", chinese: "這附近有大創嗎？", pinyin: "Zhè fùjìn yǒu Dàchuàng ma?", vietnamese: "Gần đây有 Daiso không?" },
  ...
  { id: 298, category: "生活", chinese: "祝大家學業進步，事事順心！", pinyin: "Zhù dàjiā xuéyè jìnbù", vietnamese: "Chúc mọi người học tập tiến bộ, mọi sự thuận lợi!" },
